...
import commonfunction.ExcelRead;
import commonfunction.WriteExcel;

public class RW {
	
    public static ExcelRead data = new ExcelRead("C:\\Users\\Arati\\workspace\\SurveyCertificate\\Excel\\Book14.xlsx"); // Read excel path
	
	public WriteExcel write_data = new WriteExcel("C:\\Users\\Arati\\workspace\\SurveyCertificate\\Excel\\Book14.xlsx");
	
	
	public String url = data.getData(0, 1, 1);   //get the url from excel sheet
	
	public String Dashboard = data.getData(0, 2, 1); // Comman page when any error occur
